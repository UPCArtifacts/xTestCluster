...
public class BaseSecantSolver_ESTest extends BaseSecantSolver_ESTest_scaffolding {
  ...
  public void test13()  throws Throwable  {
      PegasusSolver pegasusSolver0 = new PegasusSolver(5663.023505693385);
      Rint rint0 = new Rint();
      AllowedSolution allowedSolution0 = AllowedSolution.ABOVE_SIDE;
      double double0 = pegasusSolver0.solve(1191, (UnivariateRealFunction) rint0, (-1294.137785654395), 0.0, 0.0, allowedSolution0);
      assertEquals((-1294.137785654395), pegasusSolver0.getMin(), 0.01);
