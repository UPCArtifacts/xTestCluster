...
public class BaseSecantSolver_ESTest extends BaseSecantSolver_ESTest_scaffolding {
  ...
  public void test16()  throws Throwable  {
      Inverse inverse0 = new Inverse();
      IllinoisSolver illinoisSolver0 = new IllinoisSolver(1568.8541464688965, 1568.8541464688965);
      AllowedSolution allowedSolution0 = AllowedSolution.BELOW_SIDE;
      double double0 = illinoisSolver0.solve(1056, (UnivariateRealFunction) inverse0, (-2484.728446650176), 0.7853981633974483, allowedSolution0);
      assertEquals(0.7853981633974483, illinoisSolver0.getMax(), 0.01);
      assertEquals((-2483.9430484867785), double0, 0.01);
  }
