...
public class RegressionTest1 {
    ...
    public void test0514() throws Throwable {
        ...
        multiplePiePlot19.handleClick(100, (int) (byte) 1, plotRenderingInfo24);
        multiplePiePlot19.zoom((double) (byte) 0);
        ...
        multiplePiePlot10.setInsets(rectangleInsets30, true);
        multiplePiePlot4.setInsets(rectangleInsets30, true);
        org.junit.Assert.assertTrue("'" + boolean2 + "' != '" + false + "'", boolean2 == false);
        org.junit.Assert.assertTrue("'" + boolean5 + "' != '" + false + "'", boolean5 == false);
        org.junit.Assert.assertNull(str11);
        org.junit.Assert.assertNotNull(paint14);
    ...
    public void test0596() throws Throwable {
        ...
        multiplePiePlot17.setForegroundAlpha((float) (-1));
        java.awt.Paint paint31 = multiplePiePlot17.getNoDataMessagePaint();
        org.jfree.chart.plot.Plot plot32 = multiplePiePlot17.getRootPlot();
        org.jfree.chart.plot.DrawingSupplier drawingSupplier33 = plot32.getDrawingSupplier();
