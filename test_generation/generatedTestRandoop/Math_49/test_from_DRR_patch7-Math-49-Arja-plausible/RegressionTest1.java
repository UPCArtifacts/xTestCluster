...
public class RegressionTest1 {
    ...
    public void test0503() throws Throwable {
        ...
        double double6 = openIntToDoubleHashMap4.get(32);
        org.junit.Assert.assertTrue("'" + boolean3 + "' != '" + false + "'", boolean3 == false);
    ...
    public void test0506() throws Throwable {
        ...
        double double17 = openIntToDoubleHashMap1.remove(1);
        org.junit.Assert.assertTrue("'" + double3 + "' != '" + 52.0d + "'", double3 == 52.0d);
    ...
    public void test0510() throws Throwable {
        ...
        boolean boolean11 = openIntToDoubleHashMap4.containsKey(100);
    ...
    public void test0512() throws Throwable {
        ...
        double double20 = openIntToDoubleHashMap1.put((int) (byte) 100, (double) 1.0f);
        org.junit.Assert.assertTrue("'" + double3 + "' != '" + 52.0d + "'", double3 == 52.0d);
        org.junit.Assert.assertTrue("'" + boolean5 + "' != '" + false + "'", boolean5 == false);
        org.junit.Assert.assertTrue("'" + double8 + "' != '" + 52.0d + "'", double8 == 52.0d);
        org.junit.Assert.assertTrue("'" + double10 + "' != '" + 52.0d + "'", double10 == 52.0d);
