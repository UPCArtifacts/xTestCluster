...
public class RegressionTest5 {
    ...
    public void test2503() throws Throwable {
        ...
        double[] doubleArray39 = new double[] { ' ', (-1.0f), (-1.0f), 100L, 1.0d, 0.0f };
        // The following exception was thrown during execution in test generation
        try {
            org.apache.commons.math.optimization.VectorialPointValuePair vectorialPointValuePair40 = levenbergMarquardtOptimizer3.optimize((int) (short) 100, differentiableMultivariateVectorialFunction29, doubleArray31, doubleArray32, doubleArray39);
            org.junit.Assert.fail("Expected exception of type java.lang.NullPointerException; message: null");
        } catch (java.lang.NullPointerException e) {
            // Expected exception.
        }
        ...
        org.junit.Assert.assertEquals(java.util.Arrays.toString(doubleArray39), "[32.0, -1.0, -1.0, 100.0, 1.0, 0.0]");
    }
