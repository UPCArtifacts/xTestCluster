...
//       Node node0 = compiler0.parseSyntheticCode("no calls to next() since the last call to remove()", "f6qhiKW");
...
//       JSModule jSModule0 = new JSModule("800");
//       // Undeclared exception!
//       try { 
//         Normalize.parseAndNormalizeTestCode(compiler0, "800");
//         fail("Expecting exception: IllegalArgumentException");
//       
//       } catch(IllegalArgumentException e) {
//          //
...
//   }
  ...
  public void test06()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        functionInjector0.inline((Node) null, "L~aHk4|!U_!p}%", (Node) null, functionInjector_InliningMode0);
  ...
  public void test07()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        functionInjector0.doesFunctionMeetMinimumRequirements("tweak {0} registered with {1} must have a default value that is a literal of type {2}", (Node) null);
        fail("Expecting exception: NullPointerException");
...
//       // Undeclared exception!
//       try { 
//         compiler0.parseSyntheticCode("unexpected", "unexpected");
//         fail("Expecting exception: IllegalArgumentException");
//       
//       } catch(IllegalArgumentException e) {
//          //
...
//       ReferenceCollectingCallback referenceCollectingCallback0 = new ReferenceCollectingCallback(compiler0, referenceCollectingCallback_Behavior0, predicate0);
//       NodeTraversal nodeTraversal0 = new NodeTraversal(compiler0, referenceCollectingCallback0);
//       Node node0 = compiler0.parseSyntheticCode("unexpected", "IMPLICIT_CAST");
//       FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.BLOCK;
