...
public class GaussianFitter_ESTest extends GaussianFitter_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      WeightedObservedPoint weightedObservedPoint0 = new WeightedObservedPoint(2, 13.07, 13.07);
      WeightedObservedPoint weightedObservedPoint1 = new WeightedObservedPoint(13.07, 96.726269266, 96.726269266);
      WeightedObservedPoint[] weightedObservedPointArray0 = new WeightedObservedPoint[4];
      weightedObservedPointArray0[0] = weightedObservedPoint0;
      weightedObservedPointArray0[1] = weightedObservedPoint0;
      weightedObservedPointArray0[2] = weightedObservedPoint1;
      WeightedObservedPoint weightedObservedPoint2 = new WeightedObservedPoint(1991.0712104283207, 492.588694932622, 96.726269266);
      weightedObservedPointArray0[3] = weightedObservedPoint2;
      GaussianFitter.ParameterGuesser gaussianFitter_ParameterGuesser0 = new GaussianFitter.ParameterGuesser(weightedObservedPointArray0);
      double[] doubleArray0 = gaussianFitter_ParameterGuesser0.guess();
      assertArrayEquals(new double[] {96.726269266, 96.726269266, 0.0}, doubleArray0, 0.01);
  }
  ...
  public void test02()  throws Throwable  {
      ...
      weightedObservedPointArray0[0] = weightedObservedPoint0;
      weightedObservedPointArray0[1] = weightedObservedPoint0;
      WeightedObservedPoint weightedObservedPoint2 = new WeightedObservedPoint(Double.NEGATIVE_INFINITY, 1766.846684, 67.5017834492794);
      ...
      GaussianFitter.ParameterGuesser gaussianFitter_ParameterGuesser0 = new GaussianFitter.ParameterGuesser(weightedObservedPointArray0);
      double[] doubleArray0 = gaussianFitter_ParameterGuesser0.guess();
      assertArrayEquals(new double[] {645.0456, 24.0, 397.93305451961896}, doubleArray0, 0.01);
  }
  ...
  public void test03()  throws Throwable  {
      ...
      MultiStartDifferentiableMultivariateVectorialOptimizer multiStartDifferentiableMultivariateVectorialOptimizer0 = new MultiStartDifferentiableMultivariateVectorialOptimizer(differentiableMultivariateVectorialOptimizer0, 1016, uncorrelatedRandomVectorGenerator0);
  ...
  public void test08()  throws Throwable  {
      WeightedObservedPoint weightedObservedPoint0 = new WeightedObservedPoint(Double.NEGATIVE_INFINITY, 13.07, 2);
      WeightedObservedPoint weightedObservedPoint1 = new WeightedObservedPoint(13.07, (-2166.732729392682), Double.NEGATIVE_INFINITY);
      WeightedObservedPoint[] weightedObservedPointArray0 = new WeightedObservedPoint[7];
      ...
      GaussianFitter.ParameterGuesser gaussianFitter_ParameterGuesser0 = new GaussianFitter.ParameterGuesser(weightedObservedPointArray0);
      double[] doubleArray0 = gaussianFitter_ParameterGuesser0.guess();
      assertArrayEquals(new double[] {2.0, 13.07, 925.6769892002652}, doubleArray0, 0.01);
  }
  ...
  public void test09()  throws Throwable  {
      ...
      gaussianFitter_ParameterGuesser0.guess();
      double[] doubleArray0 = gaussianFitter_ParameterGuesser0.guess();
      assertArrayEquals(new double[] {Double.NEGATIVE_INFINITY, (-603.9680573306124), 0.0}, doubleArray0, 0.01);
  }
