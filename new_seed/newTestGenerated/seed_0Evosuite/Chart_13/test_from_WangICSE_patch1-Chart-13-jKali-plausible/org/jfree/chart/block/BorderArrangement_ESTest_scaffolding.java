...
public class BorderArrangement_ESTest_scaffolding {
  ...
  private static void initMocksToAvoidTimeoutsInTheTests() throws ClassNotFoundException { 
    ...
    mock(Class.forName("java.sql.ResultSet", false, BorderArrangement_ESTest_scaffolding.class.getClassLoader()));
    mock(Class.forName("java.sql.ResultSetMetaData", false, BorderArrangement_ESTest_scaffolding.class.getClassLoader()));
