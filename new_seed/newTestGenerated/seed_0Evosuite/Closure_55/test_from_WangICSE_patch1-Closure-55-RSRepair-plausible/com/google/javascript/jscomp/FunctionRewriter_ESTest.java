...
public class FunctionRewriter_ESTest extends FunctionRewriter_ESTest_scaffolding {
  ...
  public void test3()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      FunctionRewriter functionRewriter0 = new FunctionRewriter(compiler0);
      Node node0 = compiler0.parseSyntheticCode("function JSompiler_identityFn() {  return function(JSCompiler_identityFn_value) {return JSCompiler_identityF_value}}", "function JSompiler_identityFn() {  return function(JSCompiler_identityFn_value) {return JSCompiler_identityF_value}}");
  ...
  public void test4()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Node node0 = compiler0.parseSyntheticCode("function JSCompiler_set(JSCompile_set_name) {  return function(JSCompiler_set_value) {this[JSCompiler_set_name] = JSCompiler_set_value}}", "function JSCompiler_set(JSCompile_set_name) {  return function(JSCompiler_set_value) {this[JSCompiler_set_name] = JSCompiler_set_value}}");
      node0.setType((-1));
      FunctionRewriter functionRewriter0 = new FunctionRewriter(compiler0);
      functionRewriter0.process(node0, node0);
  ...
  public void test5()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      FunctionRewriter functionRewriter0 = new FunctionRewriter(compiler0);
      Node node0 = compiler0.parseSyntheticCode("JSCompiler_identityF_value", "function JSCompiler_returnArg(JSCompiler_returnArg_value) {  return function() {return JSCompiler_returnArg_value}}");
      functionRewriter0.process(node0, node0);
  ...
  public void test6()  throws Throwable  {
      ...
      compiler0.parseSyntheticCode("function JSCompiler_identityFn() {  return function(JSCompiler_identityFn_value) {return JSCompiler_identityFn_value}}", "FAILED ASSERTION");
      FunctionRewriter functionRewriter0 = new FunctionRewriter(compiler0);
      functionRewriter0.process(node0, node0);
