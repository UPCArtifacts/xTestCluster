...
public class FunctionInjector_ESTest extends FunctionInjector_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      Node node0 = Node.newString(16384, "", (-535), 2147483645);
      Node node1 = new Node(2, node0, node0, node0, 2147483645, 54);
  ...
  public void test05()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        functionInjector0.inline((Node) null, "|Q0>)2p%d.=", (Node) null, functionInjector_InliningMode0);
  ...
  public void test06()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        functionInjector0.doesFunctionMeetMinimumRequirements("|Q0>)2p%d.=", (Node) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test07()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, true);
      Node node0 = Node.newNumber((double) 2147483645, 2147483645, (-1664));
      // Undeclared exception!
      try { 
        functionInjector0.doesFunctionMeetMinimumRequirements("sanityCheckAst", node0);
        fail("Expecting exception: IllegalArgumentException");
  ...
  public void test10()  throws Throwable  {
      ...
      Set<String> set0 = WhitelistWarningsGuard.loadWhitelistedJsWarnings(charSource0);
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, false, true, false);
      JSModule jSModule0 = new JSModule("@P]#0?vY");
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.DIRECT;
  ...
  public void test11()  throws Throwable  {
      ...
      GatherRawExports gatherRawExports0 = new GatherRawExports(compiler0);
      Set<String> set0 = gatherRawExports0.getExportedVariableNames();
      Node node0 = Node.newNumber((double) 2147483645, (-857), (-857));
  ...
  public void test14()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      Node node0 = Node.newNumber((double) 138, 138, 5);
      Node node1 = new Node(51, node0, node0, node0, 96, (-8));
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, false, false);
  ...
  public void test16()  throws Throwable  {
      Compiler compiler0 = new Compiler();
      GatherRawExports gatherRawExports0 = new GatherRawExports(compiler0);
      Node node0 = Node.newNumber((-391.558341), 138, 0);
      Node node1 = new Node(556, node0, node0, node0, 8, (-542));
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, false, true, false);
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.DIRECT;
  ...
  public void test18()  throws Throwable  {
      ...
      InlineSimpleMethods inlineSimpleMethods0 = new InlineSimpleMethods(compiler0);
      Set<String> set0 = inlineSimpleMethods0.externMethods;
      Node node0 = Node.newNumber((-961.1129903295232), (-2083), (-2083));
      Node node1 = new Node(36, node0, node0, node0, 43, 49);
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.DIRECT;
  ...
  public void test19()  throws Throwable  {
      ...
      Iterator<CharSource> iterator0 = linkedHashSet0.iterator();
      CharSource charSource0 = CharSource.concat(iterator0);
      Set<String> set0 = WhitelistWarningsGuard.loadWhitelistedJsWarnings(charSource0);
      Node node0 = Node.newNumber((-2144.43535), 138, 138);
      Node node1 = new Node(216, node0, node0, node0, 0, (-2));
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.DIRECT;
