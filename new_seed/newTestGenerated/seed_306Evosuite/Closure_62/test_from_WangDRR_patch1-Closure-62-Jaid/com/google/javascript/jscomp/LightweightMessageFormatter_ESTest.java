...
public class LightweightMessageFormatter_ESTest extends LightweightMessageFormatter_ESTest_scaffolding {
  ...
  public void test08()  throws Throwable  {
      LightweightMessageFormatter.LineNumberingFormatter lightweightMessageFormatter_LineNumberingFormatter0 = new LightweightMessageFormatter.LineNumberingFormatter();
      SimpleRegion simpleRegion0 = new SimpleRegion(2911, 2911, ")6aE[w}iQDm3gP2Yx6");
      String string0 = lightweightMessageFormatter_LineNumberingFormatter0.formatRegion(simpleRegion0);
      assertEquals("  2911| )6aE[w}iQDm3gP2Yx6", string0);
      assertNotNull(string0);
  }
  ...
  public void test09()  throws Throwable  {
      LightweightMessageFormatter.LineNumberingFormatter lightweightMessageFormatter_LineNumberingFormatter0 = new LightweightMessageFormatter.LineNumberingFormatter();
      SimpleRegion simpleRegion0 = new SimpleRegion(955, 955, "");
      String string0 = lightweightMessageFormatter_LineNumberingFormatter0.formatRegion(simpleRegion0);
      assertNull(string0);
  }
  ...
  public void test11()  throws Throwable  {
      ...
      LightweightMessageFormatter lightweightMessageFormatter0 = LightweightMessageFormatter.withoutSource();
      JSError jSError0 = JSError.make("@nosideeffects may only appear in externs files.", (-1), (-1), diagnosticType0.defaultLevel, diagnosticType0, (String[]) null);
      String string0 = lightweightMessageFormatter0.formatWarning(jSError0);
      assertEquals("@nosideeffects may only appear in externs files.: WARNING - @nosideeffects may only appear in externs files.\n", string0);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      JSError jSError0 = JSError.make("JSC_REFLECT_CONSTRUCTOR_EXPECTED", 163, 163, diagnosticType0, stringArray0);
      String string0 = lightweightMessageFormatter0.formatError(jSError0);
      assertEquals("JSC_REFLECT_CONSTRUCTOR_EXPECTED:163: ERROR - Constructor expected as first argument\n", string0);
  }
  ...
  public void test14()  throws Throwable  {
      LightweightMessageFormatter.LineNumberingFormatter lightweightMessageFormatter_LineNumberingFormatter0 = new LightweightMessageFormatter.LineNumberingFormatter();
      SimpleRegion simpleRegion0 = new SimpleRegion((-1), (-1494), "WARNING - Exceeded max number of code motion iterations: {0}\n");
      String string0 = lightweightMessageFormatter_LineNumberingFormatter0.formatRegion(simpleRegion0);
      assertNotNull(string0);
      assertEquals("     -1| WARNING - Exceeded max number of code motion iterations: {0}", string0);
  }
}
