...
public class LightweightMessageFormatter_ESTest extends LightweightMessageFormatter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      SimpleRegion simpleRegion0 = new SimpleRegion(1, (-32), "^\n");
  ...
  public void test01()  throws Throwable  {
      SimpleRegion simpleRegion0 = new SimpleRegion((-18), (-18), "^\n");
      LightweightMessageFormatter.LineNumberingFormatter lightweightMessageFormatter_LineNumberingFormatter0 = new LightweightMessageFormatter.LineNumberingFormatter();
      String string0 = lightweightMessageFormatter_LineNumberingFormatter0.formatRegion(simpleRegion0);
      assertNotNull(string0);
  ...
  public void test07()  throws Throwable  {
      LightweightMessageFormatter.LineNumberingFormatter lightweightMessageFormatter_LineNumberingFormatter0 = new LightweightMessageFormatter.LineNumberingFormatter();
      SimpleRegion simpleRegion0 = new SimpleRegion((-1), (-1), "c%/(T");
      String string0 = lightweightMessageFormatter_LineNumberingFormatter0.formatRegion(simpleRegion0);
      assertEquals("  -1| c%/(T", string0);
      assertNotNull(string0);
  }

  @Test(timeout = 4000)
  public void test08()  throws Throwable  {
      SimpleRegion simpleRegion0 = new SimpleRegion(57, 0, "");
      LightweightMessageFormatter.LineNumberingFormatter lightweightMessageFormatter_LineNumberingFormatter0 = new LightweightMessageFormatter.LineNumberingFormatter();
      String string0 = lightweightMessageFormatter_LineNumberingFormatter0.formatRegion(simpleRegion0);
      assertNull(string0);
  }
  ...
  public void test11()  throws Throwable  {
      ...
      assertEquals("WARNING - Suspicious code. {0}\n", string0);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      JSError jSError0 = JSError.make("JSC_NAME_REFERENCE_IN_EXTERNS", (-3999), (-3999), diagnosticType0, (String[]) null);
      String string0 = lightweightMessageFormatter0.formatWarning(jSError0);
      assertEquals("JSC_NAME_REFERENCE_IN_EXTERNS: WARNING - accessing name {0} in externs has no effect\n", string0);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      JSError jSError0 = JSError.make("", 2000, 2000, diagnosticType0, (String[]) null);
      String string0 = lightweightMessageFormatter0.formatError(jSError0);
      assertEquals(":2000: ERROR - The body of a goog.scope function cannot reference this.\n", string0);
  }
