...
public class LightweightMessageFormatter_ESTest extends LightweightMessageFormatter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      SimpleRegion simpleRegion0 = new SimpleRegion(29, 29, "\n");
  ...
  public void test02()  throws Throwable  {
      ...
      JSError jSError0 = JSError.make("JSC_OBJECT_PROPERTY_STRING_STRING_LITERAL_EXPECTED", 127, 127, compiler0.MOTION_ITERATIONS_ERROR, stringArray0);
  ...
  public void test06()  throws Throwable  {
      LightweightMessageFormatter.LineNumberingFormatter lightweightMessageFormatter_LineNumberingFormatter0 = new LightweightMessageFormatter.LineNumberingFormatter();
      SimpleRegion simpleRegion0 = new SimpleRegion(137, 137, "C@6Js^O#<h`,2YZ=");
      String string0 = lightweightMessageFormatter_LineNumberingFormatter0.formatRegion(simpleRegion0);
      assertNotNull(string0);
  }
  ...
  public void test09()  throws Throwable  {
      LightweightMessageFormatter.LineNumberingFormatter lightweightMessageFormatter_LineNumberingFormatter0 = new LightweightMessageFormatter.LineNumberingFormatter();
      SimpleRegion simpleRegion0 = new SimpleRegion((-1), (-533), "ERROR - module {0} cannot reference {2}, defined in module {1}\n");
      String string0 = lightweightMessageFormatter_LineNumberingFormatter0.formatRegion(simpleRegion0);
      assertNotNull(string0);
      assertEquals("    -1| ERROR - module {0} cannot reference {2}, defined in module {1}", string0);
  }
  ...
  public void test10()  throws Throwable  {
      ...
      JSError jSError0 = JSError.make("com.google.javascript.jscomp.deps.SortedDependencies$CircularDependencyException", 10, 10, diagnosticType0, stringArray0);
      String string0 = lightweightMessageFormatter0.formatWarning(jSError0);
      assertEquals("com.google.javascript.jscomp.deps.SortedDependencies$CircularDependencyException:10: WARNING - The local variable {0} is in a goog.scope and is not an alias.\n", string0);
  }
  ...
  public void test11()  throws Throwable  {
      ...
      JSError jSError0 = JSError.make("", (-41), (-41), diagnosticType0, (String[]) null);
      String string0 = lightweightMessageFormatter0.formatError(jSError0);
      assertEquals(": ERROR - Property {0} of type {1} has been deprecated.\n", string0);
  }
  ...
  public void test12()  throws Throwable  {
      ...
      String string0 = lightweightMessageFormatter0.formatWarning(jSError0);
      assertEquals("WARNING - module {0} cannot reference {2}, defined in module {1}\n", string0);
  }
