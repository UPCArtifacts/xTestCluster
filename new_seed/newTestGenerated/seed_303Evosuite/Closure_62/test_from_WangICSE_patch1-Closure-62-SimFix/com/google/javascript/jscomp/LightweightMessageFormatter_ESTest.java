...
public class LightweightMessageFormatter_ESTest extends LightweightMessageFormatter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      SimpleRegion simpleRegion0 = new SimpleRegion((-1830), 95, "jW2AFb*2?=7d)hu");
  ...
  public void test01()  throws Throwable  {
      LightweightMessageFormatter.LineNumberingFormatter lightweightMessageFormatter_LineNumberingFormatter0 = new LightweightMessageFormatter.LineNumberingFormatter();
      SimpleRegion simpleRegion0 = new SimpleRegion((-4250), (-4250), "^\n");
      String string0 = lightweightMessageFormatter_LineNumberingFormatter0.formatRegion(simpleRegion0);
      assertEquals("  -4250| ^", string0);
  ...
  public void test06()  throws Throwable  {
      LightweightMessageFormatter.LineNumberingFormatter lightweightMessageFormatter_LineNumberingFormatter0 = new LightweightMessageFormatter.LineNumberingFormatter();
      SimpleRegion simpleRegion0 = new SimpleRegion((-622), (-622), " Q6Gj .");
      String string0 = lightweightMessageFormatter_LineNumberingFormatter0.formatRegion(simpleRegion0);
      assertNotNull(string0);
      assertEquals("  -622|  Q6Gj .", string0);
  }

  @Test(timeout = 4000)
  public void test07()  throws Throwable  {
      LightweightMessageFormatter.LineNumberingFormatter lightweightMessageFormatter_LineNumberingFormatter0 = new LightweightMessageFormatter.LineNumberingFormatter();
      SimpleRegion simpleRegion0 = new SimpleRegion((-508), (-508), "");
      String string0 = lightweightMessageFormatter_LineNumberingFormatter0.formatRegion(simpleRegion0);
      assertNull(string0);
  }
  ...
  public void test09()  throws Throwable  {
      SimpleRegion simpleRegion0 = new SimpleRegion(2426, 2426, "\n");
      LightweightMessageFormatter.LineNumberingFormatter lightweightMessageFormatter_LineNumberingFormatter0 = new LightweightMessageFormatter.LineNumberingFormatter();
      String string0 = lightweightMessageFormatter_LineNumberingFormatter0.formatRegion(simpleRegion0);
      assertEquals("  2426| ", string0);
      assertNotNull(string0);
  }
  ...
  public void test10()  throws Throwable  {
      ...
      JSError jSError0 = JSError.make("goog.testing.ObjectPropertyString instantiated with \"{0}\" arguments, expected 2.", 66, (-1), diagnosticType0.level, diagnosticType0, (String[]) null);
      String string0 = lightweightMessageFormatter0.formatWarning(jSError0);
      assertEquals("goog.testing.ObjectPropertyString instantiated with \"{0}\" arguments, expected 2.:66: WARNING - goog.testing.ObjectPropertyString instantiated with \"{0}\" arguments, expected 2.\n", string0);
  }
  ...
  public void test11()  throws Throwable  {
      ...
      JSError jSError0 = JSError.make("JSC_CONSTANT_PROPERTY_REASSIGNED_VALUE", (-1), (-1), diagnosticType0, (String[]) null);
      String string0 = lightweightMessageFormatter0.formatWarning(jSError0);
      assertEquals("JSC_CONSTANT_PROPERTY_REASSIGNED_VALUE: WARNING - constant property {0} assigned a value more than once\n", string0);
  }
  ...
  public void test13()  throws Throwable  {
      ...
      String string0 = lightweightMessageFormatter0.formatWarning(jSError0);
      assertEquals("WARNING - constant property {0} assigned a value more than once\n", string0);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      LightweightMessageFormatter lightweightMessageFormatter1 = new LightweightMessageFormatter(compiler0, sourceExcerptProvider_SourceExcerpt0);
