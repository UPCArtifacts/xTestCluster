...
public class LightweightMessageFormatter_ESTest extends LightweightMessageFormatter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      SimpleRegion simpleRegion0 = new SimpleRegion(136, 2, "\"|^~`h");
  ...
  public void test01()  throws Throwable  {
      SimpleRegion simpleRegion0 = new SimpleRegion((-1272), (-1272), "^\n");
      LightweightMessageFormatter.LineNumberingFormatter lightweightMessageFormatter_LineNumberingFormatter0 = new LightweightMessageFormatter.LineNumberingFormatter();
  ...
  public void test07()  throws Throwable  {
      LightweightMessageFormatter.LineNumberingFormatter lightweightMessageFormatter_LineNumberingFormatter0 = new LightweightMessageFormatter.LineNumberingFormatter();
      SimpleRegion simpleRegion0 = new SimpleRegion(865, 865, "pz!j|@?");
      String string0 = lightweightMessageFormatter_LineNumberingFormatter0.formatRegion(simpleRegion0);
      assertEquals("  865| pz!j|@?", string0);
      assertNotNull(string0);
  }
  ...
  public void test08()  throws Throwable  {
      LightweightMessageFormatter.LineNumberingFormatter lightweightMessageFormatter_LineNumberingFormatter0 = new LightweightMessageFormatter.LineNumberingFormatter();
      SimpleRegion simpleRegion0 = new SimpleRegion((-1292), 58, "");
      String string0 = lightweightMessageFormatter_LineNumberingFormatter0.formatRegion(simpleRegion0);
      assertNull(string0);
  }
  ...
  public void test10()  throws Throwable  {
      SimpleRegion simpleRegion0 = new SimpleRegion((-1292), (-1292), "\n");
      LightweightMessageFormatter.LineNumberingFormatter lightweightMessageFormatter_LineNumberingFormatter0 = new LightweightMessageFormatter.LineNumberingFormatter();
      String string0 = lightweightMessageFormatter_LineNumberingFormatter0.formatRegion(simpleRegion0);
      assertEquals("  -1292| ", string0);
      assertNotNull(string0);
  }
  ...
  public void test11()  throws Throwable  {
      ...
      JSError jSError0 = JSError.make("message not initialized using goog.getMsg", 10, 10, diagnosticType0, (String[]) null);
      String string0 = lightweightMessageFormatter0.formatWarning(jSError0);
      assertEquals("message not initialized using goog.getMsg:10: WARNING - message not initialized using goog.getMsg\n", string0);
  }
  ...
  public void test12()  throws Throwable  {
      LightweightMessageFormatter lightweightMessageFormatter0 = LightweightMessageFormatter.withoutSource();
      DiagnosticType diagnosticType0 = JsMessageVisitor.MESSAGE_NOT_INITIALIZED_USING_NEW_SYNTAX;
      JSError jSError0 = JSError.make("JSC_MSG_NOT_INITIALIZED_USING_NEW_SYNTAX", (-1), (-1), diagnosticType0, (String[]) null);
      String string0 = lightweightMessageFormatter0.formatError(jSError0);
      assertEquals("JSC_MSG_NOT_INITIALIZED_USING_NEW_SYNTAX: ERROR - message not initialized using goog.getMsg\n", string0);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      String string0 = lightweightMessageFormatter0.formatError(jSError0);
      assertEquals("ERROR - Duplicate input: null\n", string0);
  }

  @Test(timeout = 4000)
  public void test15()  throws Throwable  {
      LightweightMessageFormatter.LineNumberingFormatter lightweightMessageFormatter_LineNumberingFormatter0 = new LightweightMessageFormatter.LineNumberingFormatter();
      String string0 = lightweightMessageFormatter_LineNumberingFormatter0.formatLine("y", (-1265));
