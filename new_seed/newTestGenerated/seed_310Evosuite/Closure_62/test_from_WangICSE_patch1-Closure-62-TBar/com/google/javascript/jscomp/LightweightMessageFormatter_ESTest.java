...
public class LightweightMessageFormatter_ESTest extends LightweightMessageFormatter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      SimpleRegion simpleRegion0 = new SimpleRegion(7057, 7057, "\n");
      String string0 = lightweightMessageFormatter_LineNumberingFormatter0.formatRegion(simpleRegion0);
      assertEquals("  7057| ", string0);
  ...
  public void test01()  throws Throwable  {
      ...
      JSError jSError0 = JSError.make("Exceeded max number of optimization iterations: null", (-1), (-1), compiler0.OPTIMIZE_LOOP_ERROR, stringArray0);
      String string0 = lightweightMessageFormatter0.formatError(jSError0);
      assertEquals("Exceeded max number of optimization iterations: null: ERROR - Exceeded max number of optimization iterations: null\n", string0);
  }
  ...
  public void test03()  throws Throwable  {
      LightweightMessageFormatter.LineNumberingFormatter lightweightMessageFormatter_LineNumberingFormatter0 = new LightweightMessageFormatter.LineNumberingFormatter();
      String string0 = lightweightMessageFormatter_LineNumberingFormatter0.formatLine("YK5", (-2570));
      assertEquals("YK5", string0);
  }
  ...
  public void test11()  throws Throwable  {
      ...
      JSError jSError0 = JSError.make("HoE:$O%(IT", 1313, 1313, diagnosticType0, stringArray0);
      String string0 = lightweightMessageFormatter0.formatWarning(jSError0);
      assertEquals("HoE:$O%(IT:1313: WARNING - Illegal annotation on {0}. @implicitCast may only be used in externs.\n", string0);
  }
  ...
  public void test14()  throws Throwable  {
      LightweightMessageFormatter.LineNumberingFormatter lightweightMessageFormatter_LineNumberingFormatter0 = new LightweightMessageFormatter.LineNumberingFormatter();
      SimpleRegion simpleRegion0 = new SimpleRegion((-1), 172, "^\n");
      String string0 = lightweightMessageFormatter_LineNumberingFormatter0.formatRegion(simpleRegion0);
      assertNotNull(string0);
