...
public class LightweightMessageFormatter_ESTest extends LightweightMessageFormatter_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      SimpleRegion simpleRegion0 = new SimpleRegion((-3736), 11, "fCxM,u");
  ...
  public void test01()  throws Throwable  {
      SimpleRegion simpleRegion0 = new SimpleRegion(869, 869, "\n");
      LightweightMessageFormatter.LineNumberingFormatter lightweightMessageFormatter_LineNumberingFormatter0 = new LightweightMessageFormatter.LineNumberingFormatter();
      String string0 = lightweightMessageFormatter_LineNumberingFormatter0.formatRegion(simpleRegion0);
      assertEquals("  869| ", string0);
  ...
  public void test08()  throws Throwable  {
      LightweightMessageFormatter.LineNumberingFormatter lightweightMessageFormatter_LineNumberingFormatter0 = new LightweightMessageFormatter.LineNumberingFormatter();
      SimpleRegion simpleRegion0 = new SimpleRegion(172, 1861, " LgP&JE6+L: ERROR - interface member functions must have an empty body\n");
      String string0 = lightweightMessageFormatter_LineNumberingFormatter0.formatRegion(simpleRegion0);
      assertEquals("   172|  LgP&JE6+L: ERROR - interface member functions must have an empty body", string0);
      assertNotNull(string0);
  }
  ...
  public void test09()  throws Throwable  {
      LightweightMessageFormatter.LineNumberingFormatter lightweightMessageFormatter_LineNumberingFormatter0 = new LightweightMessageFormatter.LineNumberingFormatter();
      SimpleRegion simpleRegion0 = new SimpleRegion(406, 406, "");
      String string0 = lightweightMessageFormatter_LineNumberingFormatter0.formatRegion(simpleRegion0);
      assertNull(string0);
  }
  ...
  public void test11()  throws Throwable  {
      LightweightMessageFormatter.LineNumberingFormatter lightweightMessageFormatter_LineNumberingFormatter0 = new LightweightMessageFormatter.LineNumberingFormatter();
      SimpleRegion simpleRegion0 = new SimpleRegion((-3), (-3), " ");
      String string0 = lightweightMessageFormatter_LineNumberingFormatter0.formatRegion(simpleRegion0);
  ...
  public void test12()  throws Throwable  {
      ...
      JSError jSError0 = JSError.make("JSC_UNKNOWN_OVERRIDE", 58, 58, diagnosticType0, (String[]) null);
      String string0 = lightweightMessageFormatter0.formatWarning(jSError0);
      assertEquals("JSC_UNKNOWN_OVERRIDE:58: WARNING - property {0} not defined on any superclass of {1}\n", string0);
  }
  ...
  public void test15()  throws Throwable  {
      ...
      DiagnosticType diagnosticType0 = TypeCheck.INTERFACE_FUNCTION_NOT_EMPTY;
      String[] stringArray0 = new String[4];
      JSError jSError0 = JSError.make(" LgP&JE6+L", (-3282), (-3282), diagnosticType0, stringArray0);
      String string0 = lightweightMessageFormatter0.formatError(jSError0);
      assertEquals(" LgP&JE6+L: ERROR - interface member functions must have an empty body\n", string0);
  }
