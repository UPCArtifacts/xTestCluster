...
public class FunctionInjector_ESTest extends FunctionInjector_ESTest_scaffolding {
  ...
  public void test00()  throws Throwable  {
      ...
      Node node0 = compiler0.parseTestCode("inlineFunctions");
  ...
  public void test01()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        compiler0.parseTestCode("inlineFunctions");
  ...
  public void test05()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        functionInjector0.inline((Node) null, "U", (Node) null, functionInjector_InliningMode0);
  ...
  public void test06()  throws Throwable  {
      ...
      // Undeclared exception!
      try { 
        functionInjector0.doesFunctionMeetMinimumRequirements("?^CFLb=@<T-3B", (Node) null);
        fail("Expecting exception: NullPointerException");
  ...
  public void test07()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, true);
      Node node0 = Node.newString((-953), "", (-953), (-953));
      // Undeclared exception!
      try { 
  ...
  public void test09()  throws Throwable  {
      ...
      JSModule jSModule0 = new JSModule("inlineFunctions");
      Node node0 = Node.newString((-3782), "com.google.javascript.jscomp.FunctionInjector$CanInlineResult");
  ...
  public void test10()  throws Throwable  {
      ...
      JSModule jSModule1 = new JSModule("Only define(function() ...), define(OBJECT_LITERAL) and define(['dep', 'dep1'], function(d0, d2, [exports, module]) ...) forms are currently supported.");
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.BLOCK;
  ...
  public void test12()  throws Throwable  {
      ...
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, true);
      JSModule jSModule0 = new JSModule("");
      Node node0 = Node.newString((-3586), "");
      LinkedHashSet<FunctionInjector.Reference> linkedHashSet0 = new LinkedHashSet<FunctionInjector.Reference>();
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.BLOCK;
      FunctionInjector.Reference functionInjector_Reference0 = new FunctionInjector.Reference(node0, jSModule0, functionInjector_InliningMode0);
      linkedHashSet0.add(functionInjector_Reference0);
  ...
  public void test13()  throws Throwable  {
      ...
      Node node0 = Node.newString((-3586), "");
      LinkedHashSet<FunctionInjector.Reference> linkedHashSet0 = new LinkedHashSet<FunctionInjector.Reference>();
      boolean boolean0 = functionInjector0.inliningLowersCost(jSModule0, node0, linkedHashSet0, (Set<String>) null, false, false);
      assertTrue(boolean0);
  }
  ...
  public void test14()  throws Throwable  {
      ...
      Supplier<String> supplier0 = compiler0.getUniqueNameIdSupplier();
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, true);
      JSModule jSModule0 = new JSModule("wZR,_@LTd");
      Node node0 = Node.newString((-3586), "$wc}$z6y");
      LinkedHashSet<FunctionInjector.Reference> linkedHashSet0 = new LinkedHashSet<FunctionInjector.Reference>();
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.DIRECT;
      FunctionInjector.Reference functionInjector_Reference0 = new FunctionInjector.Reference(node0, jSModule0, functionInjector_InliningMode0);
      linkedHashSet0.add(functionInjector_Reference0);
  ...
  public void test15()  throws Throwable  {
      ...
      FunctionInjector functionInjector0 = new FunctionInjector(compiler0, supplier0, true, true, false);
      FunctionInjector.InliningMode functionInjector_InliningMode0 = FunctionInjector.InliningMode.DIRECT;
      Node node0 = Node.newString(7, "T", 7, (-1091));
      // Undeclared exception!
      try { 
        functionInjector0.inline(node0, "T", node0, functionInjector_InliningMode0);
        fail("Expecting exception: NullPointerException");
