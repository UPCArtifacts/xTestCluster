...
public class GaussianFitter_ESTest extends GaussianFitter_ESTest_scaffolding {
  ...
  public void test01()  throws Throwable  {
      ...
      WeightedObservedPoint weightedObservedPoint1 = new WeightedObservedPoint(2.0, (-3.141592653589793), 1160.1341059505085);
      WeightedObservedPoint[] weightedObservedPointArray0 = new WeightedObservedPoint[5];
      WeightedObservedPoint weightedObservedPoint2 = new WeightedObservedPoint(0.0, 2.0, 0.0);
      ...
      assertArrayEquals(new double[] {1160.1341059505085, (-3.141592653589793), 111.09776512276252}, doubleArray0, 0.01);
  }
  ...
  public void test04()  throws Throwable  {
      ...
      WeightedObservedPoint weightedObservedPoint1 = new WeightedObservedPoint((-1784.0), 993.30124913596, 2515.536513160186);
      weightedObservedPointArray0[3] = weightedObservedPoint1;
      WeightedObservedPoint weightedObservedPoint2 = new WeightedObservedPoint(1495.0, 2390.38485, 1495.0);
      weightedObservedPointArray0[4] = weightedObservedPoint2;
      GaussianFitter.ParameterGuesser gaussianFitter_ParameterGuesser0 = new GaussianFitter.ParameterGuesser(weightedObservedPointArray0);
      double[] doubleArray0 = gaussianFitter_ParameterGuesser0.guess();
      assertArrayEquals(new double[] {2515.536513160186, 993.30124913596, 651.2572838268641}, doubleArray0, 0.01);
  }
  ...
  public void test09()  throws Throwable  {
      WeightedObservedPoint weightedObservedPoint0 = new WeightedObservedPoint((-1981.8641), 1410.95022378811, 0.0);
      WeightedObservedPoint weightedObservedPoint1 = new WeightedObservedPoint(1410.95022378811, (-1887.0), (-2003.5706));
      WeightedObservedPoint[] weightedObservedPointArray0 = new WeightedObservedPoint[7];
      weightedObservedPointArray0[0] = weightedObservedPoint0;
      weightedObservedPointArray0[1] = weightedObservedPoint0;
      ...
      GaussianFitter.ParameterGuesser gaussianFitter_ParameterGuesser0 = new GaussianFitter.ParameterGuesser(weightedObservedPointArray0);
      double[] doubleArray0 = gaussianFitter_ParameterGuesser0.guess();
      assertArrayEquals(new double[] {0.0, 1410.95022378811, 1400.5105106639965}, doubleArray0, 0.01);
  }
  ...
  public void test10()  throws Throwable  {
      ...
      weightedObservedPointArray1[2] = weightedObservedPoint0;
      weightedObservedPointArray1[3] = weightedObservedPoint0;
      weightedObservedPointArray1[4] = weightedObservedPoint0;
      weightedObservedPointArray1[5] = weightedObservedPointArray0[0];
      weightedObservedPointArray1[6] = weightedObservedPointArray0[0];
