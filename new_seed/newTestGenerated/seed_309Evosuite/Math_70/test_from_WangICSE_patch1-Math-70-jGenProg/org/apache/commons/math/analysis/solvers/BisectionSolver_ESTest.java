...
public class BisectionSolver_ESTest extends BisectionSolver_ESTest_scaffolding {
  ...
  public void test08()  throws Throwable  {
      ...
      BisectionSolver bisectionSolver0 = new BisectionSolver(polynomialFunction0);
      try { 
        bisectionSolver0.solve((UnivariateRealFunction) polynomialFunction0, 0.015401763, 2.2874782564897582E27, 0.015401763);
        fail("Expecting exception: Exception");
  ...
  public void test16()  throws Throwable  {
      double[] doubleArray0 = new double[2];
      doubleArray0[1] = 3.065993070602417E-4;
      PolynomialFunction[] polynomialFunctionArray0 = new PolynomialFunction[1];
      PolynomialFunction polynomialFunction0 = new PolynomialFunction(doubleArray0);
      polynomialFunctionArray0[0] = polynomialFunction0;
      PolynomialSplineFunction polynomialSplineFunction0 = new PolynomialSplineFunction(doubleArray0, polynomialFunctionArray0);
      ...
      try { 
        bisectionSolver0.solve(3.065993070602417E-4, 1.0, 1.0);
        fail("Expecting exception: Exception");
  ...
  public void test17()  throws Throwable  {
      ...
      PolynomialFunction polynomialFunction0 = new PolynomialFunction(doubleArray0);
      BisectionSolver bisectionSolver0 = new BisectionSolver(polynomialFunction0);
      bisectionSolver0.setAbsoluteAccuracy((-23.984811299224578));
      try { 
        bisectionSolver0.solve((-23.984811299224578), 0.5, 0.5);
        fail("Expecting exception: Exception");
  ...
  public void test21()  throws Throwable  {
      ...
      BisectionSolver bisectionSolver0 = new BisectionSolver(polynomialFunctionLagrangeForm0);
      try { 
        bisectionSolver0.solve(1163.3607, 1286.6347389803811);
        fail("Expecting exception: Exception");
  ...
  public void test23()  throws Throwable  {
      ...
      PolynomialFunction polynomialFunction0 = new PolynomialFunction(doubleArray0);
      try { 
        bisectionSolver0.solve((UnivariateRealFunction) polynomialFunction0, 0.0, 2.314031741802188E59);
        fail("Expecting exception: Exception");
  ...
  public void test25()  throws Throwable  {
      BisectionSolver bisectionSolver0 = new BisectionSolver();
      bisectionSolver0.setMaximalIterationCount((-2787));
      try { 
        bisectionSolver0.solve((double) (-2787), 1.0E-15);
        fail("Expecting exception: Exception");
      
      } catch(Exception e) {
         //
         // Maximal number of iterations (-2,787) exceeded
         //
         verifyException("org.apache.commons.math.analysis.solvers.BisectionSolver", e);
      }
  }
